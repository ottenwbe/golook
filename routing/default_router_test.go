...
var _ = Describe("The report service", func() {
	...
	It("should call the golook cmd with a given file", func() {
	...
	It("should NOT call the golook cmd with a non existing file", func() {
	...
	It("should call the golook cmd for a given folder", func() {
		RunWithMockedGolookClientF(func() {
	...
	It("should call the golook cmd with files from existing folder which replace reported files", func() {
		RunWithMockedGolookClient(func() {
	...
	It("should NOT call the golook cmd with files from existing folder when folder does not exist", func() {
		RunWithMockedGolookClient(func() {
...
var _ = Describe("The query service", func() {
	...
	It("should call the golook cmd", func() {
		RunWithMockedGolookClient(func() {
